...
public class MainActivityTest {
    ...
    public void clickOnFirstItem_opensComments() {
        ...
        onView(withContentDescription(com.android.example.basicsample.kotlin.R.string.cd_products_list))
                .perform(RecyclerViewActions.actionOnItemAtPosition(0, click()));

        // Then the second screen with the comments should appear.
        onView(withContentDescription(com.android.example.basicsample.kotlin.R.string.cd_comments_list))
                .check(matches(isDisplayed()));

        // Then the second screen with the comments should appear.
        onView(withContentDescription(com.android.example.basicsample.kotlin.R.string.cd_product_name))
