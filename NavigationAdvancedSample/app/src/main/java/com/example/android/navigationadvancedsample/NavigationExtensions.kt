...
fun BottomNavigationView.setupWithNavController(
    ...
    //
    // So we have to pass the ids in reverse order so that fragment attached is called at last
    // Otherwise it throws an error in case this extension is used within a fragment
    navGraphIds.reversed().forEachIndexed { index, navGraphId ->
        ...
        if (this.selectedItemId == graphId) {
            ...
            attachNavHostFragment(fragmentManager, navHostFragment, index == navGraphIds.lastIndex)
        } else {
